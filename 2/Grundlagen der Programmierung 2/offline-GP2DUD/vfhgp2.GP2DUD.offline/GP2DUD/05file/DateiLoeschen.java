...
public class DateiLoeschen {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length != 2) {
            ...
            System.out.println("\ndatei:  Datei die gelöscht werden soll.");
            System.out.println("verz:  Verzeichnis in der die zu "
                    + "löschende Datei gespeichert ist.");
            System.exit(1);
        }
        // Datei loeschen
     ...
     * @param verz
     *            Verzeichnis in der zu loeschende Datei gespeichert ist
     * @throws IOException
     */
    private static void loescheDatei(String datei, String verz)
            throws IOException {
        ...
        if (removeFile.delete()) {
            ...
            System.out.println("\nDie Datei '" + datei + "' wurde "
                    + "aus dem Verzeichnis: '" + verz + "' gelöscht.\n");
        }
    }
}