...
/**
 * Based on
 * https://apexapps.oracle.com/pls/apex/f?p=44785:145:2808890149081::NO:RP,145:P145_EVENT_ID,P145_PREV_PAGE:5067,2
 * <p>
...
public class RandomWords {
	...
	public List<String> select(int listSize) {
		...
		return rand.ints(listSize, 0, sourceWords.size()).mapToObj(sourceWords::get).collect(Collectors.toList());
	}
