...
public class BogenAufgabe extends JFrame {
    // Alle BogenAufgabe-Objekte haben die gleiche Breite und Hoehe
     ...
     */
    public BogenAufgabe(int x, int y, int b, int h, int startwinkel,
            int drehwinkel) {
        this.x = x;
        this.y = y;
        this.b = b;
    ...
    public static void main(String[] args) {
        new BogenAufgabe(40, 60, 200, 40, 90, -270);
    }
